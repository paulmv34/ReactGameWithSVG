import { type Entity, Powerup, Tank, Terrain } from '@/mechanics/models'
import { type DamageSettings, EntityEvent } from '@/mechanics/models/Entity/types'
import { EventEmitter, hasKey } from '@/mechanics/utils'
import { type Game } from '../'
import { SoundPathList } from '../Resources/data'
import { type ActivatedSounds } from './types'

export class AudioManager extends EventEmitter {
  private isStopped = false
  // isMuteKeyPressed и isPauseKeyPressed Пока не используются, потом добавлю кнопки
  ...
  registerGlobalEvents() {
    ...
    // Нужны два одинаковых звука, иначе из-за быстрого проигрывания происходят искажения, будет использовано на экране окончания игры с подсчетом статистики)
