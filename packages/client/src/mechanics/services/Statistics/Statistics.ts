import { type Entity, Explosion, Powerup, Bullet, Score, TankEnemy, TankPlayer } from '@/mechanics/models'
import { EntityEvent } from '@/mechanics/models'
import { type EnemyVariant, type PlayerVariant } from '@/mechanics/models/Tank/types'
import { type Game, type GameMode } from '../'
import { type EnemiesKilledState } from './types'
...
export class Statistics {
  ...
  getCurrentStatistics() {
    const { mapEnemiesKilledCount, mode, sessionScore } = this
  ...
  countPoints(entity: TankEnemy | Powerup) {
    ...
    if (entity.destroyedBy instanceof Bullet && entity.destroyedBy.parent instanceof TankPlayer) {
